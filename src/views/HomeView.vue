...
<template>
  <AppCmsLayout :title="`${t('app.welcome', { appName })}`">
    <template #content>
      <h1>h1 Heading 🦄</h1>
      <h2>h2 Heading</h2>
      <h3>h3 Heading</h3>
...
<span class="hljs-built_in">console</span>.log(foo(<span class="hljs-number">5</span>));
      ...
      <p>
        Footnote 1 link<sup class="footnote-ref"><a
          id="fnref1"
          href="#fn1"
        >[1]</a></sup>.
      </p>
      <p>
        Footnote 2 link<sup class="footnote-ref"><a
          id="fnref2"
          href="#fn2"
        >[2]</a></sup>.
      </p>
      <p>
        Inline footnote<sup class="footnote-ref"><a
          id="fnref3"
          href="#fn3"
        >[3]</a></sup> definition.
      </p>
      <p>
        Duplicated footnote reference<sup class="footnote-ref"><a
          id="fnref2:1"
          href="#fn2"
        >[2:1]</a></sup>.
      </p>
